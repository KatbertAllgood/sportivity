...
class UpdateActivityStatisticUseCase (private val databaseRepository: DatabaseRepository) {
    operator fun invoke(activityStatisticDomain: ActivityStatisticDomain) =
        databaseRepository.updateActivityStatistic(activityStatisticDomain)
}